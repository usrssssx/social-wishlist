...
_DETAIL_MAP: dict[str, str] = {
    ...
    'Sentry is not configured': 'Sentry не настроен в продакшене.',
    'Alerts test token is not configured': 'Токен проверки алертов не настроен.',
    'Invalid alerts test token': 'Неверный токен проверки алертов.',
    ...
    'OAuth redirect base URL is invalid': 'Неверно настроен URL возврата OAuth.',
    'OAuth callback URL is invalid': 'Неверно настроен callback URL OAuth.',
    ...
    'OAuth email is not verified': 'OAuth email не подтвержден у провайдера.',
